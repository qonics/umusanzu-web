                  ...
                  <div class="bg-primary bg-soft">
                    <div class="row">
                      ...
                      <div class="col-5 align-self-end">
                        <img
                          src="@/assets/elements/profile-img.png"
                          alt=""
                          class="img-fluid"
                        />
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                          <img
                            src="@/assets/elements/avatar-1.jpg"
                            alt=""
                        ...
                        <div class="mt-4 mt-sm-0" style="position: relative">
                          <div class="resize-triggers">
                            <div class="expand-trigger">
                              <div style="width: 229px; height: 200px"></div>
                            </div>
              ...
              <div class="col-xl-8">
                ...
                <div class="card">
                  <div class="card-body" style="position: relative">
                    ...
                    <div class="resize-triggers">
                      <div class="expand-trigger">
                        <div style="width: 1063px; height: 443px"></div>
                      </div>
                      <div class="contract-trigger"></div>
                    </div>
                  </div>
                      ...
                      <table class="table align-middle table-nowrap">
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div
                                class="progress bg-transparent progress-sm"
                              >
                                <div
                      ...
                      <table class="table align-middle table-nowrap mb-0">
                        <thead class="table-light">
                          <tr>
                            <th style="width: 20px">
                              <div
                                class="form-check font-size-16 align-middle"
                              >
                                <input
